...
<nav class="navbar navbar-expand-sm navbar-dark bg-dark fixed-top" >
    <ul class="navbar-nav ">
        ...
        <img class="logo" src="../img/3.jpg" class="img-fluid"></div>
  ...
  <div class="container-fluid">
    ...
    <div class="col-md-4 mt-5">
      ...
      <div class="col-md-8 mt-5">
        ...
        <h1 id="h2dis" style="color: white;">Wecome to <span class="wobblefont"><b>service center</b></span></h1>
        ...
        <p>Auto services is India’s leading chain of multi-brand car and bike service center
        ...
        <a  class="btn btn-outline-secondary bg-primary text-white ml-auto" href="login.php" >Sign in</a>
        <a  class="btn btn-outline-secondary bg-primary text-white ml-auto" href="registration.php" >Sign up</a>
      </div>
      </div>
